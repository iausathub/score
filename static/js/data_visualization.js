...
function initializeMagnitudeHistogram() {
    ...
    try {
        const constellationData = JSON.parse(constellationDataElement.textContent.trim());
        const magnitudeBins = JSON.parse(magnitudeBinsElement.textContent.trim());

        magnitudeChart = createMagnitudeHistogram(canvasElement, constellationData, magnitudeBins);
