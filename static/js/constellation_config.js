...
window.ConstellationConfig = {
    colors: {
        light: { starlink: '#142943', amazonleo: '#fbb552', qianfan: '#8e44ad', spacemobile: '#0891b2', oneweb: '#c0392b', planetlabs: '#65a30d', other: '#5c7da7' },
        dark: { starlink: '#4a9eff', amazonleo: '#e18605', qianfan: '#9b59b6', spacemobile: '#22d3ee', oneweb: '#ec7063', planetlabs: '#a3e635', other: '#8ba3c4' }
    },
